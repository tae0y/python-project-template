...
- Local template path (if available): `/Users/bachtaeyeong/10_SrcHub/python-template`
...
1. **Local path** — if `/Users/bachtaeyeong/10_SrcHub/python-template` exists, use it directly. No clone needed.
2. **Clone** — otherwise:
